                        ...
                        <div class="card-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled value="{{ $enqueteSociale->date_enquete }}" name="date_enquete"
                                        placeholder="الاسم الكامل" class="form-control" type="date">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->nom_prenom }}" name="nom_prenom"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->type_residance }}" name="type_residance"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->lieu_naissance }}" name="lieu_naissance"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->date_naissance }}" name="date_naissance"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea disabled value="{{ $enqueteSociale->info_enfant }}" name="info_enfant" placeholder="معلومات عن الطفل"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->niveau_scolaire }}"
                                            name="niveau_scolaire" placeholder="المستوى الدراسي" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->etat_sante }}" name="etat_sante"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{ $enqueteSociale->etat_social }}" name="etat_social"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->nbr_frr }}" name="nbr_frr"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">عدد الاخوة
                                                الاناث</label>
                                            <input disabled value="{{ $enqueteSociale->nbr_soeur }}" name="nbr_soeur"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->tuteur_age }}" name="tuteur_age"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->tuteur_metier }}"
                                                name="tuteur_metier" class="form-control" type="text"
                                                placeholder="المهنة">
                                        </div>
                                    </div>
                                    <div class="form-check form-check-info text-start justify-content-start col-sm-3">
                                        <input disabled value="متوفي" name="tuteur_etat"
                                    ...
                                    <div class="form-check form-check-info text-start justify-content-start col-sm-3">
                                        <input disabled value="على قيد الحياة" name="tuteur_etat"
                                            class="form-check-input float-end" type="checkbox" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">
                                            على قيد الحياة
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">المستوى
                                                الدراسي</label>
                                            <input disabled value="{{ $enqueteSociale->etat_scolarite }}"
                                                name="etat_scolarite" class="form-control" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">الاصل
                                                الجغرافي</label>
                                            <input disabled value="{{ $enqueteSociale->origine_geographique }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->type_residance }}"
                                                name="type_residance" class="form-control" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->residence }}" name="residence"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">عدد أفراد
                                                الاسرة</label>
                                            <input disabled value="{{ $enqueteSociale->nbr_membre_famille }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->nbr_chambre }}"
                                                class="form-control" type="number" name="nbr_chambre"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">عدد
                                                المقيمين</label>
                                            <input disabled value="{{ $enqueteSociale->nbr_habitant }}"
                                                class="form-control" type="number" name="nbr_habitant"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input disabled value="{{ $enqueteSociale->source_de_vie }}"
                                                class="form-control" type="text" name="source_de_vie"
                                                placeholder="مصدر العيش">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">الطلب</label>
                                            <input disabled value="{{ $demande->nom_prenom_enfant }}"
                                                class="form-control" type="text" name="source_de_vie"
                                                placeholder="مصدر العيش">
                                        </div>
                                    </div>
