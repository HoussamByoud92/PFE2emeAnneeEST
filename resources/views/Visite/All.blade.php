            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('crea', $beneficiaire->id) }}"
                            class="btn btn-m btn-link mx-auto mb-0 d-none d-lg-block"><i
                                class="fas fa-plus"></i>&nbsp;&nbsp;اضافة زيارة</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($visite as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->rapport }}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="ml-auto text-center">
                                                    <form id="deleteForm" onsubmit="return confirmDelete()"
                                                        action="{{ route('visite.destroy', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
