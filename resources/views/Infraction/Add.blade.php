                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="date" placeholder="الاسم الكامل" class="form-control"
                                            type="date">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">                                            نوع المخالفة
                                        </label>
                                        <input name="type" placeholder="نوع المخالفة
                                        " class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">القرار
                                            </label>
                                        <input name="decision" placeholder="القرار" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                            </div>
